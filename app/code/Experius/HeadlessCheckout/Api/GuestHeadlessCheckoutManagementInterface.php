...
/**
 * Interface for managing guest headless checkout
 * @api
 */
interface GuestHeadlessCheckoutManagementInterface
{
    /**
     * Update checkout state for a specified guest cart.
     *
     * @param string $cartId
    ...
    /**
     * Place order for a specified guest cart.
     *
     * @param string $cartId
